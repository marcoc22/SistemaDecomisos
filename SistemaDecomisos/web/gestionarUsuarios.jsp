                            ...
                            <div class="x_content" hidden="true">
                                <form id="form_agregar_usuario" role="form" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" id="nueva_contraseña" disabled="true" class="col-md-2"> 
                                    ...
                                    <div class="form-group">
                                      <div class="col-md-9 col-md-offset-3">
                                        ...
                                        <button type="reset" class="btn btn-danger btn-sm" id="cancelar_agregar_usuario"><i class="fa fa-remove"></i> Cancelar</button>
                                      </div>
                                    </div>
                                </form>
                            </div>
